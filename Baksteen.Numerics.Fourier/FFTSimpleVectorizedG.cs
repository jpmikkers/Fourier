    ...
    private static unsafe void Butterflies(Complex* peven, Complex* pw, int numbtf, int wstride)
    {
        for (var t = 0; t < numbtf; t++)
        {
            ...
            var odd0 = ComplexMulSse2b(
                ...
                Sse2.LoadAlignedVector128((double*)pw)
            //Vector128.Create(pw->Real, pw->Imaginary)   // this is 5% slower
            );
            pw += wstride;
